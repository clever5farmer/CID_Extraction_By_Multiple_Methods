...
class DilatedNet(nn.Module):
    def __init__(self, inplanes, planes, stride=1) -> None:
        ...
        self.dilated5 = DilatedBlock(inplanes=planes5, planes=planes6//4, name='hdc5')
        ...
        self.dilated9 = DilatedBlock(inplanes=planes9, planes=planes10//4, name='hdc9')
        self.dilated10 = DilatedBlock(inplanes=planes10, planes=planes11//4, name='hdc10')
        self.dilated11 = DilatedBlock(inplanes=planes11, planes=planes12//4, name='hdc10')
        self.dilated12 = DilatedBlock(inplanes=planes12, planes=planes13//4, name='hdc10')
        self.conv19 =  nn.Sequential(
            nn.Conv2d(planes13, planes, 1, padding='same'),
            nn.Sigmoid())
    ...
    def forward(self, x):
        ...
        dilated6 = self.dilated6(dilated5)
        dilated7 = self.dilated7(dilated6)
        dilated8 = self.dilated8(dilated7)
        dilated9 = self.dilated9(dilated8)
        dilated10 = self.dilated10(dilated9)
        dilated11 = self.dilated11(dilated10)
        dilated12 = self.dilated12(dilated11)
        out = self.conv19(dilated12)
